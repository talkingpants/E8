...
$kqlPath = Join-Path $paths.KqlDir 'E8-ML1-PA-04-Office_query.kql'
$templatePath = Join-Path $paths.MsgDir 'E8-ML1-PA-04-Office_message.html'
...
if ($result.Results.Count) {
    ...
    $htmlTable = "<p>No devices with Office vulnerabilities found.</p>"
}

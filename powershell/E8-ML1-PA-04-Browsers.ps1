...
$kqlPath = Join-Path $PSScriptRoot 'E8-ML1-PA-04-Browser_query.kql'
...
$templatePath = Join-Path $PSScriptRoot 'E8-ML1-PA-04-Browser_message.html'
...
# Send the report
$subject = "E8-ML1-PA-04 Browser Vulnerabilities Report - $stamp @@@"
